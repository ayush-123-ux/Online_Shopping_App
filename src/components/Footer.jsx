                ...
                <Row className="gy-2">
                    <Col md={3}>
                        <div className="footer-brand mb-3">
                            <a href="https://github.com/ayush-123-ux/Online_Shopping_App" 
                    ...
                    <Col md={3}>
                        ...
                        <div className="quick-links-group">
                            <div className="quick-link-item">
                                ...
                                <a href="https://github.com/ayush-123-ux/Online_Shopping_App" className="footer-link">Privacy Policy</a>
                            </div>
                            <div className="quick-link-item">
                                <FontAwesomeIcon icon={faLink} className="contact-icon me-2" />
                                <a href="https://github.com/ayush-123-ux/Online_Shopping_App" className="footer-link">Terms & Conditions</a>
                            </div>
                            <div className="quick-link-item">
                                <FontAwesomeIcon icon={faLink} className="contact-icon me-2" />
                                <a href="https://github.com/ayush-123-ux/Online_Shopping_App" className="footer-link">Return Policy</a>
                            </div>
                        </div>
                    </Col>
                    ...
                    <Col md={3}>
                        ...
                        <div className="quick-links-group">
                            <div className="quick-link-item">
                                <FontAwesomeIcon icon={faLink} className="contact-icon me-2" />
                                <a href="https://github.com/ayush-123-ux/Online_Shopping_App" className="footer-link">Shipping Info</a>
                            </div>
                            <div className="quick-link-item">
                                <FontAwesomeIcon icon={faLink} className="contact-icon me-2" />
                                <a href="https://github.com/ayush-123-ux/Online_Shopping_App" className="footer-link">FAQ</a>
                            </div>
                            <div className="quick-link-item">
                                <FontAwesomeIcon icon={faLink} className="contact-icon me-2" />
                                <a href="https://github.com/ayush-123-ux/Online_Shopping_App" className="footer-link">Support</a>
                            </div>
                        </div>
                    </Col>
                    ...
                    <Col md={3} className="d-flex flex-column justify-content-center">
                        <div className="connect-section text-center">
                            ...
                            <div className="social-links-horizontal">
                                <a 
                                    href="https://github.com/ayush-123-ux/Online_Shopping_App" 
                                    target="_blank" 
